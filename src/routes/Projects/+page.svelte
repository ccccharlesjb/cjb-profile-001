				...
				<div class="flex flex-col items-center gap-4 p-4 lg:flex-row">
					...
					<div class="w-full grow">
						<h1 class="flex items-center text-xl font-bold">
							LLMo V2 Software
							<span class="mx-2 rounded bg-[#D9D5F7] px-3 py-1 text-xs font-bold uppercase">
								HEALTHCARE
							</span>
						</h1>
						<p class="text-1xl py-1">
			...
			<a href="{base}/Projects/LLMoV1">
				<div class="flex flex-col items-center gap-4 p-4 lg:flex-row">
					...
					<div class="w-full grow">
						...
						<p class="text-1xl py-1">
							Mobile app controlling a robot therapy bed, automating exercises wireless control with
							data tracking.
						</p>
						<div class="card-actions justify-end"></div>
					</div>
				...
				<div class="flex flex-col items-center gap-4 p-4 lg:flex-row">
					...
					<div class="w-full grow">
						<h1 class="flex items-center text-xl font-bold">
							...
							<span class="mx-2 rounded bg-yellow-400 px-3 py-1 text-xs font-bold uppercase">
								ENTERPRISE
							</span>
						</h1>
						<p class="text-1xl py-1">
